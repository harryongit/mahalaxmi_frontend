...
import { About, History, Architecture } from "@/src/components/temple/Sections";
        ...
        >
          ...
          <div className="container-temple relative z-10">
            ...
            >
              ...
              <span className="text-xs uppercase tracking-[0.4em]">Discover Our Legacy</span>
              <span className="h-px w-10 bg-current opacity-60" />
            </motion.div>
            ...
            >
              About <span className="text-gradient-gold">the Temple</span>
            </motion.h1>
            ...
            >
              Explore the rich history, sacred architecture, and timeless devotion of Ambabai
