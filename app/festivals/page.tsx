...
import { Festivals, Events } from "@/src/components/temple/Sections";
        ...
        >
          ...
          <div className="container-temple relative z-10">
            ...
            >
              ...
              <span className="text-xs uppercase tracking-[0.4em]">Celebrations & Utsav</span>
              <span className="h-px w-10 bg-current opacity-60" />
            </motion.div>
            ...
            >
              Festivals & <span className="text-gradient-gold">Events</span>
            </motion.h1>
            ...
            >
              Nights of fire, flowers and song — experience the vibrant celebrations at Ambabai
