...
import { Gallery } from "@/src/components/temple/Sections";
        ...
        >
          ...
          <div className="container-temple relative z-10">
            ...
            >
              ...
              <span className="text-xs uppercase tracking-[0.4em]">Visual Archive</span>
              <span className="h-px w-10 bg-current opacity-60" />
            </motion.div>
            ...
            >
              Moments of grace captured across seasons and ceremonies — selected from the temple's
              living archive.
            </motion.p>
          </div>
        </section>
