    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a href="/" className="btn-ghost-gold" style={{ color: "var(--stone-deep)", borderColor: "var(--border)", background: "white" }}>
            Go home
          </a>
        </div>
      </div>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Step into a centuries-old sanctuary. Explore the history, architecture, daily rituals and live darshan of Shri Mandir." },
